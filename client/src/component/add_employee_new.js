          ...
          if (addPostItemResult) {
            if (addPostItemResult.message) {
              ...
              Swal.fire(
                ...
                'Menambah Data Employee Berhasil',
                "success"
              );
              setAdd(false);
              navigate('/employee');
    ...
    return (
        <div>
          ...
          <Form.Group controlId="col3">
            ...
            <br></br>
            <img src={imageShow} style={{ marginLeft:'30px', width:'250px', height:'250px'}} className="img-thumbnail img-fluid" alt="..." />
            <br></br>
            {isSelec ? (
              <div>
              <br></br> 
              <button type="button" className='btn btn-danger' style={{marginLeft:'120px'}} onClick={(e) => handleClearFile()}>Remove</button>
              <br></br>
              <br></br>
              </div>
            ) : <br></br> }
